                    ...
                    <div class="col l6 s10 adjust">
                      ...
                      <div class="row spacer compress pacer">
                          <div class="button-group filters-button-group">
                              <button class="button-filter is-checked" data-filter="*">Ver todos</button>
                              <button class="button-filter" data-filter=".ios">iOS</button>
                              <button class="button-filter" data-filter=".ui-ux">UI/UX</button>
                              <button class="button-filter" data-filter=".graphics">Gráficos</button>
                          </div>
                      </div>
                      <div class="row grid">
                          ...
                          <div class="col l4 m4 s6 grid-item transition graphics">
                              ...
                              <div class="card">
                                  <div class="card-image">
                                      ...
                                      <div class="caption-wrap">
                                          <p>'EXI' - Ilustração</p>
                                          <p>Cinema4D e Adobe Photoshop</p>
                                          <div class="single-pagination-wrapper">
                                            <span class="single-pagination"></span>
                                          </div>
                                      </div>
                          ...
                          <div class="col l4 m4 s6 grid-item transition ui-ux">
                              ...
                              <div class="card">
                                  <div class="card-image">
                                      ...
                                      <div class="caption-wrap">
                                          <p>'EXI' - Website</p>
                                          <p>Balsamiq e Adobe Photoshop</p>
                                          <div class="single-pagination-wrapper">
                                            <span class="single-pagination"></span>
                                          </div>
                                      </div>
                              ...
                              <div class="card">
                                  <div class="card-image">
                                      ...
                                      <div class="caption-wrap">
                                          ...
                                          <p>Adobe Illustrator / Photoshop e Marvel</p>
                                          <div class="single-pagination-wrapper">
                                            <span class="single-pagination"></span>
                                          </div>
                                      </div>
                          ...
                          <div class="col l4 m4 s6 grid-item transition graphics">
                              ...
                              <div class="card">
                                  <div class="card-image">
                                      ...
                                      <div class="caption-wrap">
                                          <p>'UX Information Technologies' - Embalagem</p>
                                          <p>Adobe Illustrator</p>
                                          <div class="single-pagination-wrapper">
                                            <span class="single-pagination"></span>
                                          </div>
                              ...
                              <div class="card">
                                  <div class="card-image">
                                      ...
                                      <div class="caption-wrap">
                                          ...
                                          <p>Adobe Illustrator / Photoshop e Invision</p>
                                          <div class="single-pagination-wrapper">
                                            <span class="single-pagination"></span>
                                          </div>
                                      </div>
                          ...
                          <div class="col l4 m4 s6 grid-item transition graphics">
                              ...
                              <div class="card">
                                  <div class="card-image">
                                      ...
                                      <div class="caption-wrap">
                                          <p>'UX Information Technologies' - ID Corporativa</p>
                                          <p>Adobe Illustrator</p>
                                          <div class="single-pagination-wrapper">
                                            <span class="single-pagination"></span>
                                          </div>
                          ...
                          <div class="col l4 m4 s6 grid-item transition design">
                              ...
                              <div class="card">
                                  <div class="card-image">
                                      ...
                                      <div class="caption-wrap">
                                          <p>'Luis Baldini' - ID Corporativa</p>
                                          <p>Adobe Illustrator / Photoshop</p>
                                          <div class="single-pagination-wrapper">
                                            <span class="single-pagination"></span>
                                          </div>
                          ...
                          <div class="col l4 m4 s6 grid-item transition ui-ux">
                              ...
                              <div class="card">
                                  <div class="card-image">
                                      ...
                                      <div class="caption-wrap">
                                          <p>'Toysnapp' - Website E-commerce</p>
                                          <p>Adobe Illustrator / Photoshop e Invision</p>
                                          <div class="single-pagination-wrapper">
                                            <span class="single-pagination"></span>
                                          </div>
                          ...
                          <div class="col l4 m4 s6 grid-item transition graphics">
                              ...
                              <div class="card">
                                  <div class="card-image">
                                      ...
                                      <div class="caption-wrap">
                                          <p>'Qualidade 21' - ID Corporativa</p>
                                          <p>Adobe Illustrator</p>
                                          <div class="single-pagination-wrapper">
                                            <span class="single-pagination"></span>
                                          </div>
