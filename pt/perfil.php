            ...
            <div>
                ...
                <div class="row" id="section1">
                    ...
                    <div class="col l2 m3">
                        <div class="rightBar">
                            <ul class="fadeIn short delayS">
                            	<li>'Apreciei em particular a forma de trabalhar e interagir com clientes exigentes, uma competência que, no caso dos profissionais de IT, por vezes demora muitos anos a desenvolver. No caso do Paulo, ela parece natural.'</li>
                            	<li class="client fadeIn short delayM">Mário Braz<div>PricewaterhouseCoopers</div></li>
                            </ul>
                            <span class="goBottom short"></span>
                        </div>
                        ...
                        <div class="row">
                            <div class="col l4 m6 s12 spacer">
                                <h3 class="valign-wrapper">
                                    ...
                                    <span class="fadeIn medium delayM">Design Gráfico</span>
                                </h3 >
                            </div>
                            <div class="col l4 m6 s12 spacer">
                                <h3 class="valign-wrapper">
                            ...
                            <div class="col l4 m6 s12 spacer">
                                <h3 class="valign-wrapper">
                                    ...
                                    <span class="fadeIn xlong delayM">Marketing Digital</span>
                                </h3 >
                            </div>
                            <div class="col l4 m6 s12 spacer">
                                <h3 class="valign-wrapper">
                                    <img class="gridImg" src="../img/icons/motion.svg" alt="">
                                    <span class="fadeIn xlong delayL">Animação Gráfica</span>
                                </h3 >
                            </div>
                            <div class="col l4 m6 s12">
                                <h3 class="valign-wrapper">
                                    <img class="gridImg" src="../img/icons/content.svg" alt="">
                                    <span class="fadeIn xlong delayXL">Estratégia de Conteúdo</span>
                                </h3 >
                            </div>
                        </div>
                    </div>
